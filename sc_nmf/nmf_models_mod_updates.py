...
class intNMF():
    ...
    phi_atac : array-like
        tooix x region matrix. Gives the loading matrix to define topics.
    loss : float
        l2 norm of the reconstruction error
    loss_atac : float
        l2 norm for the reconstruction error of just the atac matrix
    loss_rna : float
        l2 norm for the reconstruction error of just the rna matrix 
